...
`
    ...
    async copyAssets() {
        ...
        const prodPkg = {
            ...
            scripts: {
                start: "node main.js",
                ...Object.fromEntries(Object.entries(pkg.scripts).filter(([key]) => !key.includes("build") && !key.includes("test")))
            },
            devDependencies: undefined
        }
        fs.writeFileSync(path.join(this.distDir, "package.json"), JSON.stringify(prodPkg, null, 2))
