...
import { AirModule, formatSuccess } from './ui-utils.js';
            ...
            try {
                ...
                if (this.ddnsConfig.env && airConfig[this.ddnsConfig.env]) {
                    ...
                    if (envConfig.godaddy) {
                        if (!this.ddnsConfig.domain)
                            this.ddnsConfig.domain = envConfig.godaddy.domain;
                        if (!this.ddnsConfig.host)
                            this.ddnsConfig.host = envConfig.godaddy.host;
                        if (!this.ddnsConfig.key)
                            this.ddnsConfig.key = envConfig.godaddy.key;
                        if (!this.ddnsConfig.secret)
                            this.ddnsConfig.secret = envConfig.godaddy.secret;
                    }
...
export default DDNS;
//# sourceMappingURL=ddns-new.js.map