...
class AirStatus {
    ...
    run() {
        ...
        const portColor = portStatus.inUse ? (processStatus.running ? "green" : "yellow") : "gray"
        const portInfo = portStatus.inUse ? `In use${portStatus.processInfo ? " by " + portStatus.processInfo : ""}` : "Available"
        ...
        console.log()
        // Final Status
        const finalStatus = processStatus.running ? colorize("● RUNNING", "green") : colorize("○ STOPPED", "yellow")
