...
class HonestTestSuite {
     ...
     */
    testCommand(command: string, shouldWork: boolean): TestResult {
    ...
    private saveHonestResults(): void {
...
async function runHonestTestSuite(): Promise<void> {
