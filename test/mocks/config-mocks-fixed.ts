...
import type { AirConfig, EnvironmentConfig } from '../../src/types/index.js'
...
export const mockConfig: AirConfig = {
  name: 'test-air',
  env: 'development',
  root: '/tmp/air-test',
  bash: '/bin/bash',
...
export function createMockConfig(overrides: Partial<AirConfig> = {}): AirConfig {
  return {
    ...mockConfig,
    ...overrides,
    development: {
