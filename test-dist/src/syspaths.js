...
class SystemPaths {
     ...
     */
    systemd() {
        if (this.cache.systemd)
            return this.cache.systemd;
     ...
     */
    letsencrypt() {
        if (this.cache.letsencrypt)
            return this.cache.letsencrypt;
     ...
     */
    initsystem() {
        if (this.cache.initsystem)
            return this.cache.initsystem;
        if (this.platform !== 'linux') {
...
//# sourceMappingURL=syspaths.js.map