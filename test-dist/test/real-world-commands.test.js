...
class RealWorldCommandTester {
     ...
     */
    async testCommand(command, expectSuccess = true, timeout = 10000) {
     ...
     */
    async testMultiRuntime(baseCommand) {
        const commands = [
     ...
     */
    async testPathDependentCommands() {
...
//# sourceMappingURL=real-world-commands.test.js.map