...
export const timerMocks = {
    create: () => {
        ...
        let timeouts = {};
        return {
            setTimeout: jest.fn((callback, delay, name = 'default') => {
...
export function createReporterMockContext(overrides = {}) {
    return {
...
export const reporterTestUtils = {
    ...
    createMockState: (config = {}, user = null) => ({
        user,
    ...
    createMockGunUser: (shouldFail = false) => ({
    ...
    simulateTimer: (callback, delay = 0) => {
    ...
    createMockNetworkResult: (ipv4 = '1.2.3.4', ipv6 = '2001:db8::1') => ({
        ipv4,
        ipv6,
        primary: ipv4 || ipv6,
        hasIPv6: !!ipv6
    ...
    validateStatusStructure: (status, type) => {
...
//# sourceMappingURL=reporterMocks.js.map