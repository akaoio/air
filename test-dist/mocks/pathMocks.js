...
export function createPathMockContext(overrides = {}) {
    return {
...
export const pathTestUtils = {
    ...
    mockProcessEnvironment: (cwd, env = {}) => {
        return {
            cwd: () => cwd,
            env: { ...env }
        };
    ...
    normalizePath: (pathStr, platform = 'linux') => {
        if (platform === 'win32') {
...
//# sourceMappingURL=pathMocks.js.map