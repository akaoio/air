...
export const configMocks = {
    ...
    invalid: {
        ...
        invalidPort: {
            ...
            env: 'development',
            ip: { timeout: 5000, dnsTimeout: 3000, userAgent: 'Air/2.0.0', dns: [], http: [] },
            development: { port: 'invalid', domain: 'localhost', peers: [] },
            production: { port: 8765, domain: 'localhost', peers: [] }
        },
        missingName: {
            root: '/tmp/test',
        ...
        invalidPeers: {
            ...
            env: 'development',
            ip: { timeout: 5000, dnsTimeout: 3000, userAgent: 'Air/2.0.0', dns: [], http: [] },
            development: { port: 8765, domain: 'localhost', peers: 'not-an-array' },
            production: { port: 8765, domain: 'localhost', peers: [] }
        }
    },
    // Edge cases
 ...
 */
export function createCorruptedJson() {
...
export const fsMocks = {
    readSuccess: (content) => jest.fn().mockReturnValue(JSON.stringify(content)),
...
//# sourceMappingURL=configMocks.js.map