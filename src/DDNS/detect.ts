...
export async function detect(): Promise<IPResult> {
...
async function detectIPv4(): Promise<string | null> {
    ...
    // Try HTTP method
    const httpServices = ["https://checkip.amazonaws.com", "https://ipv4.icanhazip.com", "https://api.ipify.org"]
...
async function detectIPv6(): Promise<string | null> {
    ...
    // Try HTTP method
    const httpServices = ["https://ipv6.icanhazip.com", "https://api6.ipify.org", "https://v6.ident.me"]
