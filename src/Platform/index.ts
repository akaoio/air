...
export class Platform {
    ...
    async restartService(name: string) {
        return this.strategy.restartService(name)
    }
    ...
    findProcessByPort(port: number) {
        return this.strategy.findProcessByPort(port)
    }

    findProcessByName(name: string) {
        return this.strategy.findProcessByName(name)
    }

    killProcess(pid: string | number) {
        return this.strategy.killProcess(pid)
    }

    killProcessByPort(port: number) {
        return this.strategy.killProcessByPort(port)
    }

    killProcessByName(name: string) {
        return this.strategy.killProcessByName(name)
    }
...
// Strategies are NOT exported - all operations must go through Platform abstraction
