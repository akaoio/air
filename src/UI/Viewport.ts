...
class ViewportManager extends EventEmitter {
    ...
    private setupListeners(): void {
        process.stdout.on("resize", () => {
            ...
            this.resizeTimer = setTimeout(() => {
                ...
                if (oldDimensions.width !== this.dimensions.width || oldDimensions.height !== this.dimensions.height) {
    ...
    getResponsiveWidth(
        ...
        const { margin = 2, maxWidth, minWidth = 10, preferredRatio = 1.0 } = options
