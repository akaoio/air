...
export const colors: ConsoleColors = {
    ...
    get primary() { return getTerminalInfo().supportsRGB ? '\x1b[38;2;0;212;255m' : '\x1b[96m' },      // Cyan
    get secondary() { return getTerminalInfo().supportsRGB ? '\x1b[38;2;255;107;53m' : '\x1b[93m' },   // Orange/Yellow
    get success() { return getTerminalInfo().supportsRGB ? '\x1b[38;2;0;255;136m' : '\x1b[92m' },      // Green
    get warning() { return getTerminalInfo().supportsRGB ? '\x1b[38;2;255;170;0m' : '\x1b[93m' },      // Amber/Yellow
    get error() { return getTerminalInfo().supportsRGB ? '\x1b[38;2;255;71;87m' : '\x1b[91m' },        // Red
    get info() { return getTerminalInfo().supportsRGB ? '\x1b[38;2;124;77;255m' : '\x1b[94m' },        // Purple/Blue
    get muted() { return getTerminalInfo().supportsRGB ? '\x1b[38;2;108;117;125m' : '\x1b[37m' },      // Gray/White
    get accent() { return getTerminalInfo().supportsRGB ? '\x1b[38;2;255;159;243m' : '\x1b[95m' }      // Pink/Magenta
}

// Box drawing characters - adaptive for terminal compatibility
export const box = {
    get horizontal() { return getTerminalInfo().isTermux ? '-' : '─' },
    get vertical() { return getTerminalInfo().isTermux ? '|' : '│' },
    get topLeft() { return getTerminalInfo().isTermux ? '+' : '┌' },
    get topRight() { return getTerminalInfo().isTermux ? '+' : '┐' },
    get bottomLeft() { return getTerminalInfo().isTermux ? '+' : '└' },
    get bottomRight() { return getTerminalInfo().isTermux ? '+' : '┘' },
    get cross() { return getTerminalInfo().isTermux ? '+' : '┼' },
    get teeUp() { return getTerminalInfo().isTermux ? '+' : '┴' },
    get teeDown() { return getTerminalInfo().isTermux ? '+' : '┬' },
    get teeLeft() { return getTerminalInfo().isTermux ? '+' : '┤' },
    get teeRight() { return getTerminalInfo().isTermux ? '+' : '├' },
    
    // Double line
    get doubleHorizontal() { return getTerminalInfo().isTermux ? '=' : '═' },
    get doubleVertical() { return getTerminalInfo().isTermux ? '|' : '║' },
    get doubleTopLeft() { return getTerminalInfo().isTermux ? '+' : '╔' },
    get doubleTopRight() { return getTerminalInfo().isTermux ? '+' : '╗' },
    get doubleBottomLeft() { return getTerminalInfo().isTermux ? '+' : '╚' },
    get doubleBottomRight() { return getTerminalInfo().isTermux ? '+' : '╝' },
    
    // Rounded
    get roundTopLeft() { return getTerminalInfo().isTermux ? '+' : '╭' },
    get roundTopRight() { return getTerminalInfo().isTermux ? '+' : '╮' },
    get roundBottomLeft() { return getTerminalInfo().isTermux ? '+' : '╰' },
    get roundBottomRight() { return getTerminalInfo().isTermux ? '+' : '╯' },
    
    // Thick
    get thickHorizontal() { return getTerminalInfo().isTermux ? '-' : '━' },
    get thickVertical() { return getTerminalInfo().isTermux ? '|' : '┃' }
}
